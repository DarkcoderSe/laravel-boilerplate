                            ...
                            <div class="card glass-bg">
                                ...
                                <div class="card-body">
                                    <div class="form-widget">
                                        <form class="mb-0" action="/customer" method="POST">
                                            @csrf
                                            <div class="row">

                                                <div class="col-12">
                                                    <div class="input-field">
                                                        <input name="email" type="email" id="email-name-field"
                                                            class="autocomplete white-input"  value="{{ old('email') }}">
                                                ...
                                                <div class="col-6">
                                                    <div class="input-field">
                                                        <input name="first_name" type="text" id="first-name"
                                                            class="autocomplete white-input" value="{{ old('first_name') }}">
                                                ...
                                                <div class="col-6">
                                                    <div class="input-field">
                                                        <input name="last_name" type="text" id="last-name"
                                                            class="autocomplete white-input" value="{{ old('last_name') }}">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-field">
                                                        <input name="password" type="password" id="password-field"
                                                            class="autocomplete white-input" value="{{ old('password') }}">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" name="register"
                                                        class="button button-circle btn-block button-xlarge cine-btn">Register</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
