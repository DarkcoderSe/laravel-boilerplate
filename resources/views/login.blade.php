                            ...
                            <div class="card glass-bg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-widget">
                                        ...
                                        <form class="mb-0" action="/login" method="POST">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <button type="submit" name="login"
                                                        class="button button-circle btn-block button-xlarge cine-btn">Login</button>
                                                </div>

                                                <div class="col-12">
                                                    <div class="input-field">
                                                      <a href="{{ route('customer.forgot-password') }}" > Forgot Password? Click here to reset it</a>
                                                    </div>
                                                </div>
                                            </div>
