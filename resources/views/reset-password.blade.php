...
<head>
    ...
    <!-- Document Title
	============================================= -->
    <title>Backpack | Reset Password</title>
                            ...
                            <div class="card glass-bg">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-widget">
                                        ...
                                        <form class="mb-0" action="/password.update" method="POST">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="input-field">
                                                        <input name="password" type="password"
                                                            class="autocomplete white-input">
                                                        <label for="email-name-field">Password</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="input-field">
                                                        <input name="confirm-password" type="password"
                                                            class="autocomplete white-input">
                                                        <label for="email-name-field">Confirm Password</label>
                                                    </div>
                                                </div>
